...
import ProfileHeader from "@/lib/src/providers/components/ProfileHeader";
import NoFitnessPlan from "@/lib/src/providers/components/NoFitnessPlan";
import CornerElements from "@/lib/src/providers/components/CornerElements";
...
const ProfilePage = () => {
  ...
  return (
    <section className="relative z-10 pt-12 pb-32 flex-grow container mx-auto px-4">
      <ProfileHeader user={user as unknown as UserResource } />
              ...
              <Tabs defaultValue="workout" className="w-full">
                ...
                <TabsContent value="workout">
                  <div className="space-y-4">
                    ...
                    <Accordion typeof="multiple" className="space-y-4">
